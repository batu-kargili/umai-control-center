  ...
  return (
    <div className="space-y-10 fade-up">
      ...
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-3xl border border-slate/10 bg-white p-6 shadow-sm space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full rounded-xl border border-slate/20 bg-slate-50 px-3 py-2 text-sm"
              >
          ...
          <div className="space-y-3">
            ...
            {datasetMode === "preset" ? (
              ...
              <div className="border border-dashed border-slate/40 rounded-2xl p-4 bg-slate-50 space-y-2">
          ...
          <div className="grid gap-4 md:grid-cols-[1.4fr_0.6fr] items-end">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate/20 bg-white px-3 py-2 text-sm"
              />
            </div>
            <button
              type="button"
              onClick={handleRun}
              disabled={submitting}
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-ink px-4 py-3 text-sm font-semibold text-white shadow-lift hover:bg-ink/90 disabled:opacity-60"
            >
        ...
        <div className="rounded-3xl border border-slate/10 bg-white p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-semibold text-slate flex items-center gap-2"
            >
              ...
              <button
                ...
                className={`w-full text-left rounded-2xl border p-4 transition ${
                  selectedRun?.id === run.id
                    ? "border-black/20 bg-mint"
                    : "border-slate/10 bg-white hover:border-black/10"
                }`}
              >
                <div className="flex items-center justify-between">
                  <div>
      ...
      <section className="space-y-6">
        ...
        {!selectedRun ? (
          <div className="rounded-3xl border border-slate/10 bg-white p-10 text-center text-sm text-slate">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="rounded-3xl border border-slate/10 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 text-slate">
                  <LineChart className="w-4 h-4 text-ink" />
